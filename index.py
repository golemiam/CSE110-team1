...
You should work to complete this activity for the one hour period first, without looking at the sample solution. However, if you have worked on it for at least an hour and are still having problems, you may feel free to use the sample solution to help you finish your program.
Sample solution (Core Requirements): teach02_sample.py
Sample solution (Stretch Challenges): teach02_stretch_sample.py
Submission
